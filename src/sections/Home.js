    ...
    return (
        ...
        <div className="sectionContent text-center" style={{minHeight: '80vh'}}>
            <div className="welcome-text" style={{paddingTop: '0px'}}>
                <h1 style={{fontSize: 'clamp(25px, 7.7vw, 90px)'}}> Kirsty & Gordon</h1>
            ...
            <div className="container" style={{paddingTop: '20px',}}>
                <div className="row">
                    ...
                    <div className="col-lg-10">
                        <img alt={"Image of Kirsty and Gordon"} className="img-fluid"
            ...
            <div style={{marginTop: '20px'}}>
                <p style={{fontSize: 'clamp(25px, 3vw, 45px)', fontFamily: 'Dancing Script', marginTop: 0}}>09.07.2026</p>
            </div>
